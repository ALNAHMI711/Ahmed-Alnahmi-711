...
class AlphaDecision: accepted:bool; strategy:RankedStrategy; sizing:SizingDecision
def decide(strategy:RankedStrategy, request:SizingRequest, limits:RiskLimits, journal:TradeJournal, *, symbol:str, regime:str)->AlphaDecision:
    ...
    journal.record(JournalEntry(strategy.name,symbol,regime,0.,accepted,sizing.risk.reasons))
