...
class SecretCipher:
    def __init__(self, key: str|None=None):
        ...
        if not material: raise RuntimeError('API_ENCRYPTION_KEY مطلوب؛ لا يمكن حفظ مفاتيح التداول بدون تشفير.')
    ...
    def decrypt(self, value:str)->str:
        ...
        except InvalidToken as error: raise ValueError('تعذر فك تشفير السر المخزن') from error
