...
class Position(Base):
    ...
    market: Mapped[str] = mapped_column(String(32), index=True)
    symbol: Mapped[str] = mapped_column(String(32), index=True)
    quantity: Mapped[Decimal] = mapped_column(DECIMAL, default=Decimal("0")) # signed
...
class ExchangeOrder(Base):
    ...
    id: Mapped[str] = mapped_column(String(36), primary_key=True, default=_id)
    account_id: Mapped[str] = mapped_column(String(36), ForeignKey("api_accounts.id"), index=True)
    market: Mapped[str] = mapped_column(String(32)); symbol: Mapped[str] = mapped_column(String(32))
    ...
    side: Mapped[str] = mapped_column(String(4)); order_type: Mapped[str] = mapped_column(String(32))
    quantity: Mapped[Decimal] = mapped_column(DECIMAL)
